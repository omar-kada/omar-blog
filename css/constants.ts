...
export const borderGlow = merged(border, 'dark:border-gray-200 border-gray-700')
export const borderGlowOnHover = merged(border, 'dark:hover:border-gray-200 hover:border-gray-700')
