...
export const xsSpanAuto = ' sm:col-span-auto sm:row-span-auto '
export const xsStartAuto = ' sm:col-start-auto sm:row-start-auto '
export const xsAuto = merged(xsSpanAuto, xsStartAuto)
